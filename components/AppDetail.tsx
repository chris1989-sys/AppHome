...
export const AppDetail: React.FC<AppDetailProps> = ({ app, onBack }) => {
  ...
  /**
   * Generiert die Ziel-URL basierend auf der Plattform.
   * Auf Android wird ein striktes Intent-URI-Schema verwendet, das direkt auf 
   * das Chrome-Paket (com.android.chrome) zielt.
   */
  const getLinkUrl = (url: string) => {
    if (isAndroid) {
      // Protokoll (https://) entfernen für das intent:// Schema
      const urlWithoutProtocol = url.replace(/^https?:\/\//, '');
      // Intent-URI Format:
      // - intent://[domain/path]
      // - #Intent;
      // - scheme=https;
      // - package=com.android.chrome; (Erzwingt Chrome)
      // - end
  ...
  return (
    <div className="min-h-screen bg-white animate-enter">
      ...
      <div className="max-w-2xl mx-auto px-6 pt-8 pb-32">
        <div className="flex space-x-6 mb-10">
          ...
          <div className="flex flex-col justify-center min-w-0 flex-1">
            ...
            <a 
              ...
              download={isAndroid ? "start.html" : undefined}
        ...
        {/* Floating Mobile Link mit Intent + Download-Attribut Trick */}
